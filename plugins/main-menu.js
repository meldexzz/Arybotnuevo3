...
≡ 🌲 \`Prefix :\` [ *${usedPrefix}* ]
≡ 🌷 \`Status :\` ${m.sender.split`@`[0] == fz  ? 'Developer' : m.sender.split`@`[0] == sylph ? 'Official bot (In development)' :  'Free User')}
  
\`🌱 ¿Algún comando tiene un error? ¡Infórmale al desarrollador para que lo solucione!! 🦦\`

  ╭┈──────────────── ꒰ 🌺 ꒱
 │ *𖦹 ¡Gracias por usar el bot!*
  ╰─┈➤ ‌${wm}
